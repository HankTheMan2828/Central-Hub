...
function ComposerDropdown({
  ...
  return (
    ...
    >
      ...
      <AnimatedDropdown
        open={isOpen}
        className="clouds-coding-dropdown-panel absolute left-0 top-full z-20 mt-1.5 min-w-full w-max max-w-[280px] max-h-[260px] overflow-hidden border border-[var(--agent-border)] bg-[var(--ch-bg-surface)] rounded-sm shadow-2xl p-1 flex flex-col"
      >
        {searchable && (
